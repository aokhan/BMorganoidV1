...
# Read count file
path <- "/Users/seanwen/Documents/Abs/CellPhoneDB/Output/VEGFAC CellPhoneDB/out/"
...
# Save file
#path <- "/Users/seanwen/Documents/Abs/CrossTalkeR/Input/"
#file <- "VEGFA-C_ClustersCollapsed.csv"
...
# Save file
path <- "/Users/seanwen/Documents/Abs/CrossTalkeR/Input/"
file <- "VEGFA-C_ClustersCollapsed_MyeloidRemoved.csv"
write.table(df.collapsed, paste(path, file, sep=""), sep=",", col.names=TRUE, row.names=FALSE, quote=FALSE)
